...
async (conn, mek, m, { from, prefix, quoted, q, reply }) => {
    try {
        ...
        // Validate input
        if (!q) {
            return await reply("*Example : .Pair 923360473953*");
        }

        // Fetch pairing code
        //const fetch = require("node-fetch");
        const response = await fetch(`https://mughal-md.onrender.com/code?number=${q}`);
        ...
        const doneMessage = "> *MUGHAL-MD PAIR COMPLETED*";

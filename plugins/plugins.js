...
async (conn, mek, m, { from, reply }) => {
    try {
        ...
        let pluginList = "🗃 *MUGHAL MD PLUGINS:*\n\n";
...
async (conn, mek, m, { from, reply, args, senderNumber }) => {
    try {
        ...
        if (m.quoted && m.quoted.key.fromMe) {
            ...
            if (/🗃 \*MUGHAL MD PLUGINS:\*/i.test(quotedText)) {
        ...
        const statusMessage = {
            image: { url: `https://i.ibb.co/pBgs9G7z/a003501a28842714.jpg` }, // Replace with your image URL
